...
const ProductCard = memo(({ 
    ...
    <div className="flex gap-2 sm:gap-4 !px-2 sm:!px-4 !py-2 sm:!py-4 border-b border-gray-100">
        ...
        <div className="flex-1 flex flex-col justify-between">
            <div>
                <span className="text-[10px] sm:text-[.9rem] text-gray-500 block">{product.brand || 'Marca del producto'}</span>
...
const ProductSkeleton = () => (
    <div className="flex gap-2 sm:gap-4 !px-2 sm:!px-4 !py-2 sm:!py-4 border-b border-gray-100 animate-pulse">
        <div className="w-20 h-20 sm:w-28 sm:h-28 shrink-0 bg-gray-200 rounded-lg" />
        <div className="flex-1 flex flex-col justify-between">
            <div>
                <div className="h-3 sm:h-4 bg-gray-200 rounded w-16 sm:w-20 !mb-1 sm:!mb-2" />
                <div className="h-3 sm:h-4 bg-gray-200 rounded w-full !mb-0.5 sm:!mb-1" />
                <div className="h-3 sm:h-4 bg-gray-200 rounded w-3/4 !mb-2 sm:!mb-3" />
                <div className="h-4 sm:h-6 bg-gray-200 rounded w-20 sm:w-24" />
            </div>
            <div className="h-[30px] sm:h-10 bg-gray-200 rounded-[16px] sm:rounded-full !mt-1.5 sm:!mt-3" />
        </div>
    </div>
);
...
export default function ProductListDynamic({ 
    ...
    return (
        <div className="min-h-screen bg-white match:!pt-18 4xs:!pt-18 xs:!pt-18 sm:!pt-18 md:!pt-[5%] lg:!pt-[5%] match:!pb-10 4xs:!pb-10 xs:!pb-10 sm:!pb-10 md:!pb-5 lg:!pb-5  flex flex-col md:flex-row min-w-full">
            {/* Filtros */}
            {showFilters && (
                <div className="border-b border-gray-200 !px-2 sm:!px-4 !py-2 sm:!py-4 !mt-[5%] sm:!mt-[2%] md:!mt-[2%]">
