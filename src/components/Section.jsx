...
const Section = ({ id, titulo, products }) => {
    return (
        <section 
            id={id} 
            className='w-full max-w-[2000px] mx-auto !px-2 md:!px-6 lg:!px-12 !py-3 md:!py-6 lg:!py-12 flex justify-center flex-col items-center'
        >
            <h2 
                className='text-[1.5rem] sm:text-[1.5rem] md:text-2xl lg:text-[2.5rem] font-semibold text-center !mb-2 md:!mb-5 lg:!mb-8 max-w-[180px] sm:max-w-[250px] md:max-w-[400px] lg:max-w-[600px]'
            >
                {titulo}
            </h2>
