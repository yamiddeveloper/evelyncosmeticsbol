...
const Section = ({ id, titulo, products }) => {
    return (
        ...
        >
            <h2 
                className='text-base sm:text-lg md:text-2xl lg:text-[2.5rem] font-semibold text-center !mb-2 md:!mb-5 lg:!mb-8 max-w-[180px] sm:max-w-[250px] md:max-w-[400px] lg:max-w-[600px]'
            >
                {titulo}
            </h2>
